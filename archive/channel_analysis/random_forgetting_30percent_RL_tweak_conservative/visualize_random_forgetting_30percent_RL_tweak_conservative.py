...
Run from repository root directory: python experiments/channel_analysis/random_forgetting_30percent_RL_tweak_conservative/visualize_random_forgetting_30percent_RL_tweak_conservative.py
"""
...
def visualize_top_affected_channels():
    ...
    model_path = "experiments/results/good_results/random_forgetting_30percent_RL_tweak_conservative/RLcheckpoint.pth.tar"
