...
I'm using a modified version of Lucent’s `inceptionv1`, trained from scratch on full ImageNet. The classes I target for forgetting are ImageNet classes 281–285 (various cat breeds).
