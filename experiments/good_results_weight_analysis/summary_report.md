...
Generated on: 2025-10-13 14:43:08


## Experiment: random_forgetting_10percent_RL_tweak_conservative
- **Forget Ratio**: forgetting
- **Mask Threshold**: RL
- **Unlearn Method**: conservative
- **Most Affected Layer**: layer1.1.bn1.running_mean (22.976181)
- **Least Affected Layer**: normalize.mean (0.000000)
- **Top 3 Most Changed Weights**:
  - layer3.0.conv2.weight (change: 705084.125000)
  - layer4.1.conv1.weight (change: 553044.875000)
  - layer4.0.conv2.weight (change: 346710.812500)
